...
options_ = [];
M_.fname = 'general_indet_est_learn';
...
M_.endo_names(4) = {'epsilon_d'};
M_.endo_names_tex(4) = {'epsilon\_d'};
M_.endo_names_long(4) = {'epsilon_d'};
M_.endo_names(5) = {'epsilon_s'};
M_.endo_names_tex(5) = {'epsilon\_s'};
M_.endo_names_long(5) = {'epsilon_s'};
...
M_.param_names(6) = {'rho_d'};
M_.param_names_tex(6) = {'rho\_d'};
M_.param_names_long(6) = {'rho_d'};
M_.param_names(7) = {'rho_s'};
M_.param_names_tex(7) = {'rho\_s'};
M_.param_names_long(7) = {'rho_s'};
M_.param_names(8) = {'sigma_s'};
M_.param_names_tex(8) = {'sigma\_s'};
M_.param_names_long(8) = {'sigma_s'};
M_.param_names(9) = {'sigma_d'};
M_.param_names_tex(9) = {'sigma\_d'};
M_.param_names_long(9) = {'sigma_d'};
...
M_.mapping.epsilon_d.eqidx = [1 5 ];
M_.mapping.epsilon_s.eqidx = [3 4 ];
M_.mapping.nu_d.eqidx = [5 ];
...
M_.Sigma_e(1, 3) = M_.params(13)*sqrt(M_.Sigma_e(1, 1)*M_.Sigma_e(3, 3));
M_.Sigma_e(3, 1) = M_.Sigma_e(1, 3);
M_.Correlation_matrix(1, 3) = M_.params(13);
M_.Correlation_matrix(3, 1) = M_.Correlation_matrix(1, 3);
M_.Sigma_e(2, 1) = M_.params(11)*sqrt(M_.Sigma_e(2, 2)*M_.Sigma_e(1, 1));
M_.Sigma_e(1, 2) = M_.Sigma_e(2, 1);
M_.Correlation_matrix(2, 1) = M_.params(11);
M_.Correlation_matrix(1, 2) = M_.Correlation_matrix(2, 1);
M_.Sigma_e(2, 3) = M_.params(12)*sqrt(M_.Sigma_e(2, 2)*M_.Sigma_e(3, 3));
M_.Sigma_e(3, 2) = M_.Sigma_e(2, 3);
M_.Correlation_matrix(2, 3) = M_.params(12);
...
estim_params_.param_vals = [estim_params_.param_vals; 6, 0, (-2), 2, 3, 0, 0.5, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 7, 0, (-2), 2, 3, 0, 0.5, NaN, NaN, NaN ];
...
save('general_indet_est_learn_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('general_indet_est_learn_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('general_indet_est_learn_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('general_indet_est_learn_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('general_indet_est_learn_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('general_indet_est_learn_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('general_indet_est_learn_results.mat', 'oo_recursive_', '-append');
end

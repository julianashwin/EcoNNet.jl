...
estim_params_.param_vals = [estim_params_.param_vals; 1, 0.95, 0, 2, 3, 1, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 2, 0.05, (-2), 2, 3, 0, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 3, 0.95, 0, 2, 3, 1, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 4, 0.25, (-2), 2, 3, 0, 1, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 5, 1.5, (-2), 4, 3, 2, 1, NaN, NaN, NaN ];
...
save('illus_det_est_learn_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('illus_det_est_learn_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('illus_det_est_learn_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('illus_det_est_learn_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('illus_det_est_learn_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('illus_det_est_learn_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('illus_det_est_learn_results.mat', 'oo_recursive_', '-append');
end
